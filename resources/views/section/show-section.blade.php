            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-header">
                        <span style="font-size:19px;">All Sections</span>
                        <a href="{{route('createSection')}}" class="btn btn-primary" style="float: right"><i class="fas fa-plus-circle">Add Section </i> </a>
                    </div>
                                ...
                                <div class="col-sm-12">
                                    <table id="table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 143px;">Capacity</th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 219px;">Note</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1">{{$sections->id}}</td>
                                                <td>{{$sections->name}}</td>
                                                <td>{{$sections->capacity}}</td>
                                                <td>{{$sections->iClass->name}}</td>
                                                <td>{{$sections->note}}</td>

                                                <td>

                                                    <div class="btn-group">
                                                        <a title="Edit" href="{{route('editSection',$sections->id)}}" class= "btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                                    </div>
                                                    <div class="btn-group">
                                                        <form method="POST" action="{{route('deleteSection',$sections->id)}}">
                                                            @method('DELETE')
                                                            @csrf
